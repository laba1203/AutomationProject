...
public class SimpleEditorTesting extends BaseTest {
    ...
    private SimpleEditorPage editorPage;
    ...
    public void test2_editContent(SimpleEditorPage.LocalizationType mode, String localizationName, String newValue)
    {
    ...
    public void test3_updateFriendShareEmail(){
        ...
        editorPage = new SimpleEditorPage(COPY).switchViewByNameOnSimpleEditor("Friend share email");
        editContentTest(COPY, localizationName, newValue);

    }

    private void editContentTest(SimpleEditorPage.LocalizationType mode, String localizationName, String newValue){
        editorPage = new SimpleEditorPage(mode);
